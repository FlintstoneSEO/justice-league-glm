# Business Growth Grant custom element

- Tag: `jl-business-growth-grant`
- Source: `wix-embeds/business-growth-grant-custom-element.js`
- It uses open Shadow DOM and natural content height; do not use FAQ iframe resize code or a fixed element height.
